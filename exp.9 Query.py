...
region_wise_sales = pd.pivot_table(df, values='Sale_amt', index='Region', aggfunc='sum')
print("Region wise sales:")
print(region_wise_sales)

manager_wise_sales = pd.pivot_table(df, values='Sale_amt', index='Manager', aggfunc='sum')
print("\nManager wise sales:")
print(manager_wise_sales)

salesman_wise_sales = pd.pivot_table(df, values='Sale_amt', index='SalesMan', aggfunc='sum')
print("\nSalesman wise sales:")
print(salesman_wise_sales)
