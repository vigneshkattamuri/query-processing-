...
data = {
    ...
    "JOB_TITLE": ["President", "Administration Vice President", "Administration Assistant", 
                  ...
                  "Stock Manager", "Stock Clerk", "Shipping Clerk", "Programmer", 
    ...
    "MAX_SALARY": [40000, 30000, 6000, 16000, 9000, 16000, 9000, 20080, 12008, 15000, 5500, 
                   8500, 5000, 5500, 10000, 15000, 9000, 9000, 10500]
}
...
print("Jobs sorted in descending order by job title:")
print(sorted_jobs)
